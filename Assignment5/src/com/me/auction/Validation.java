...
public class Validation {
	...
	public static void main(String args[]) throws Exception {
		...
		// running test cases
		System.out.println("=========================================");
		org.junit.runner.JUnitCore.main("com.me.auction.Validation$TestCases");
	...
	public static class TestCases {
		...
		public void maxBidCount() {
			...
			boolean isLessThan = sum == 0;
			System.out.println("--------------" + sum);
			assertEquals("failed maxBid counts items maintained by AuctionServer: " + sum, true, isLessThan);
		}
