...
public class SimulationEvent {
	public enum EventType {
		/* General events */
		SimulationStarting, SimulationEnded,
		/* Customer events */
		CustomerStarting, CustomerEnteredCoffeeShop, CustomerPlacedOrder, CustomerReceivedOrder, CustomerLeavingCoffeeShop,
		/* Cook Events */
	...
	/*
	 * Not all of these fields are relevant for every event; see factory methods
	 * below
	 */
	...
	private SimulationEvent(EventType event, Cook cook, Customer customer, Machine machine, Food food,
			List<Food> orderFood, int orderNumber, int[] simParams) {
		this.event = event;
		this.cook = cook;
	...
	public static SimulationEvent customerEnteredCoffeeShop(Customer customer) {
		return new SimulationEvent(EventType.CustomerEnteredCoffeeShop, null, customer, null, null, null, 0, null);
	}
	...
	public static SimulationEvent customerReceivedOrder(Customer customer, List<Food> order, int orderNumber) {
		return new SimulationEvent(EventType.CustomerReceivedOrder, null, customer, null, null, order, orderNumber,
				null);
	}

	public static SimulationEvent customerLeavingCoffeeShop(Customer customer) {
		return new SimulationEvent(EventType.CustomerLeavingCoffeeShop, null, customer, null, null, null, 0, null);
	}
	...
	public String toString() {
		...
		case SimulationStarting:
			...
			return "Starting simulation: " + numCustomers + " customers; " + numCooks + " cooks; " + numTables
					+ " tables; " + "machine capacity " + capacity + ".";
		...
		case MachineStarting:
			return machine + " starting up for making " + food + "; " + simParams[0] + ".";
