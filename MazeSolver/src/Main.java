...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        String mazeLocationNotInProjectFolder = "/Users/akashnagesh/Desktop/Multithreaded-programming/maze-dist/"; //replace this with your maze directory
    ...
    {
        MazeInputStream in =
                new MazeInputStream((new FileInputStream(filename)));
